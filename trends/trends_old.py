...
def seperate_string(string):
    ...
    for x in string:
        new_string = new_string + is_asc(x)
...
def find_centroid(polygon):
    ...
    while i<(len(polygon)-1):
        x = x + (polygon[i][0]+polygon[i+1][0]*(polygon[i][0]*polygon[i+1][1]-polygon[i+1][0]*polygon[i][1])
        y = y + (polygon[i][1]+polygon[i+1][1]*(polygon[i][0]*polygon[i+1][1]-polygon[i+1][0]*polygon[i][1])
